...
class DiasporaService:
    ...
    def add_routes(self) -> None:
        ...
        self.app.post('/api/v4/user', tags=['User'])(
            self.create_user,
        )
        self.app.delete('/api/v4/user', tags=['User'])(
            self.delete_user,
        )
        # Key management routes
        self.app.post('/api/v4/key', tags=['Authentication'])(
            self.create_key,
        )
        self.app.get('/api/v4/key', tags=['Authentication'])(
            self.get_key,
        )
        self.app.delete('/api/v4/key', tags=['Authentication'])(
            self.delete_key,
        )
        # Topic management routes
        self.app.post('/api/v4/{namespace}/{topic}', tags=['Topic'])(
            self.create_topic,
        )
        self.app.delete('/api/v4/{namespace}/{topic}', tags=['Topic'])(
            self.delete_topic,
        )
        self.app.put('/api/v4/{namespace}/{topic}/recreate', tags=['Topic'])(
            self.recreate_topic,
        )
        # List namespaces and topics
        self.app.get('/api/v4/namespace', tags=['Namespace'])(
